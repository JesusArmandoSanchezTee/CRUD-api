    ...
    <div>
        <div class="card">
            <div class="contenedor">
                ...
                <div class="is">
                    <router-link :to="{ path: '/rolcre' }" type="button" id="cre" class="btn btn-info">Crear
                        Rol</router-link>
                    <button type="button" v-on:click="editarrol()" class="btn btn-warning">Editar</button>
                </div>
            </div>
            <div class="card_body">
                <table class="table">
...
export default {
    ...
    methods: {
        ...
        borrarRol(id) {
            ...
            axios.delete("https://localhost:7241/Rol/" + id);

            window.location.href = 'rollis'
        },
        editarrol() {
