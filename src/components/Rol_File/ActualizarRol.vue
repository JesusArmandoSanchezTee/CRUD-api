        ...
        <div class="card">
            ...
            <div class="card-body">
                <form v-on:submit.prevent="formulario">
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <small id="peticion" class="form-text" text-muted>Ingresa id del rol que desea
                                    actualizar</small>
                                <br>
                                <br>
                                <div id="botonbusca">
                                    ...
                                    &#160
                                    <router-link :to="{ name: 'rollis' }" class="btn btn-outline-danger">Cancelar</router-link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <br>
                    <div id="botoncerrar" style="display: none;">|<router-link :to="{name:'rollis'}" type="button" class="btn btn-outline-primary">Finalizar</router-link>|</div>
...
export default {
    ...
    methods: {
        formulario() {
            ...
            axios.put('https://localhost:7241/Rol/' + this.pkRol, cuerpo).then((resutl) => {
        ...
        Buscar(id) {
            console.log(id)
            if (id > 0) {
                axios.get('https://localhost:7241/Rol/' + id).then((response) => {
