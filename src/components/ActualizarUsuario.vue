                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <small id="peticion" class="form-text" text-muted>Ingresa id del usuario que desea
                                    actualizar</small>
                                <br>
                                <br>
                                <div id="botonbusca">
...
export default {
    ...
    methods: {
        formulario() {
            ...
            axios.put('https://localhost:7241/Usuarios/' + this.pkUsuario, cuerpo).then((resutl) => {
                console.log(resutl.data);
                document.getElementById('botones').style.display = "none";
                document.getElementById("alert").style.display = "block";
                this.smg = "Se ha actualizado el usuario";
        ...
        Buscar(id) {
            console.log(id)
            if (id > 0) {
                axios.get('https://localhost:7241/Usuarios/' + id).then((response) => {
